...
\input tolkien-jmena-example-02
\unskip\unskip\unskip\unskip\unskip\unskip
\input tolkien-jmena-example-06
...
os.execute("test -e krestni-jmena-muzi.decl || bash -c 'source venv/bin/activate && source klonovani-muzi-download.sh'")
\end{luacode*}
%
\begin{luacode*}
...
V tomto článku jsme si ukázali, jak můžeme pomocí jazykových modelů automaticky generovat jména postav při tvůrčím psaní v Lua\TeX u. Dále jsme vyvinuli jsme balíček, který je přístupný laickým uživatelům \LaTeX u, a zveřejnili jsme ho online~\cite{novotny2023napadovnik}. Nakonec jsme si rozebrali možná vylepšení našeho modelu a další možné aplikace jazykových modelů v Lua\TeX u. Článek názorně ukazuje vývoj \LaTeX ového balíčku, který kombinuje kód v \TeX u s kódem v jazyce Lua, a demonstruje možnosti využití jazykových modelů v \TeX u.
