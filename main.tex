...
\NewExpandableDocumentCommand         % Vytvoř LaTeXový příkaz
...
% TODO: Ukázat, jak si můžeme vygenerovaná jména chovat pro budoucí užití: \edef nebo parametr seed.
...
vygeneruje nové jméno. Pro zachování vygenerovaných jmen můžeme použít primitivní
\TeX ový příkaz \verb|\edef|, pomocí kterého jednou zavoláme příkaz
\verb|\randomname| a jeho výstup si uložíme např. do příkazu \verb|\ČLOVĚK|.
Příkaz \verb|\ČLOVĚK| pak můžeme opakovaně použít v textu fanfikce:
...
\edef\ČLOVĚK/{\randomname{clovek}}%
\ČLOVĚK/ vyrostl v bohaté obchodnické rodině. Když však jeho otec
zesnul a rodinné jmění zpustlo, \ČLOVĚK/ se stal dobrodruhem a
nechal se najímat jako žoldnéř. Během svých dobrodružství si
\ČLOVĚK/ vydobyl pověst neohroženého válečníka a jeho meč se stal
jeho nejcennějším jměním.
\end{filecontents}
...
% TODO: Diskutovat skloňování jmen v češtině
% Viz https://www.overleaf.com/project/64479eb8de925ab422e870a4
% a https://github.com/xvrabcov/declension_names
