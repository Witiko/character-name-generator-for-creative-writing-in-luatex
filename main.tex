...
\footnotetext{Lua\TeX{} reprezentuje reálná čísla vždy pomocí 64bitových čísel s 53bitovou mantisou. Díky tomu dostaneme při použití reálné aritmetiky vždy stejné výsledky nezávisle na platformě. Zvídavý čtenář se ale jistě zamyslí, jak bychom se tu mohli reálné aritmetice zcela vyhnout.}
